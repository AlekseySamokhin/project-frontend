...
const createCustomShadow = (color) => {
  ...
  return {
    ...
    popover: `0 0 30px 15px ${alpha(color, 0.24)}`,
    before: {
      right: `0.5px -0.5px 1px 0 ${alpha(color, 0.24)}`,
      top: `-0.5px -0.5px 1px 0 ${alpha(color, 0.24)}`,
      bottom: `0.5px 0.5px 1px 0 ${alpha(color, 0.24)}`,
    },
  };
};
