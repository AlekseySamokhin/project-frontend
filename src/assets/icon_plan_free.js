...
function PlanFreeIcon({ ...other }) {
  ...
  const SECONDARY_DARK = theme.palette.primary.dark;

  const SECONDARY_MAIN = theme.palette.primary.main;
    ...
    <Box {...other}>
      ...
      >
        <g transform="translate(9.167 20)">
          <path fill={SECONDARY_MAIN} d="M53.333 17.5H61.666V25H53.333z" />
